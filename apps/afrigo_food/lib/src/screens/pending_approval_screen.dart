    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('سيتم إشعارك فور مراجعة توثيق المطعم والدراجة من طرف فريق Afrigo', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Tajawal', fontSize: 13, height: 1.7, color: Color(0xFF78716C))),
        ],
      ),
    );
  }
