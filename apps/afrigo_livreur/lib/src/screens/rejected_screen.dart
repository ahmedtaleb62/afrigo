...
class RejectedScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final reason = ref.watch(livreurFlowControllerProvider.select((s) => s.vehicleRejectionReason));
    final display = reason?.isNotEmpty == true ? reason! : 'صورة رخصة القيادة غير واضحة';
