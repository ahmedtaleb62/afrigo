      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text('قيد المراجعة', style: TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w700, fontSize: 12, color: Color(0xFF854D0E))),
          ),
          const Text('بانتظار موافقة الإدارة', style: TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w800, fontSize: 18)),
          const SizedBox(height: 8),
          const Text('سيتم إشعارك فور المراجعة. لا يمكنك استقبال الطلبات في هذه الأثناء', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Tajawal', fontSize: 13, height: 1.7, color: Color(0xFF78716C))),
          const SizedBox(height: 24),
          TextButton(
            onPressed: controller.simulateRejected,
            child: const Text('معاينة: حالة الرفض ›', style: TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w600, fontSize: 11, color: Color(0xFFA8A29E))),
          ),
        ],
      ),
    );
