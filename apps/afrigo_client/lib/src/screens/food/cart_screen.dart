      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('${s.cart[i].price} د.ج', style: const TextStyle(fontFamily: 'Tajawal', fontSize: 12, color: Color(0xFF78716C))),
                            ],
                          ),
                        ),
                ...
                const ClientTextField(hint: 'ملاحظة للمطعم (اختياري)'),
                const SizedBox(height: 14),
                Container(
                  ...
                  child: Column(
                    children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('المجموع الفرعي', style: TextStyle(fontFamily: 'Tajawal', fontSize: 13, color: Color(0xFF78716C))), Text('${s.cartSubtotal} د.ج', style: const TextStyle(fontFamily: 'Tajawal', fontSize: 13))]),
                      const SizedBox(height: 8),
                      const Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('رسوم التوصيل', style: TextStyle(fontFamily: 'Tajawal', fontSize: 13, color: Color(0xFF78716C))), Text('100 د.ج', style: TextStyle(fontFamily: 'Tajawal', fontSize: 13))]),
                      const SizedBox(height: 8),
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('الإجمالي', style: TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w800, fontSize: 14)), Text('${s.cartGrandTotal} د.ج', style: const TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w800, fontSize: 14, color: Color(0xFF166534)))]),
                    ],
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: ClientPrimaryButton(label: 'متابعة الطلب', onPressed: () => controller.goTo(ClientScreen.foodCheckout)),
          ),
        ],
      ),
    );
