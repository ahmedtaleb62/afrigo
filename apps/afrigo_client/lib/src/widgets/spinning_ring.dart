...
/// The rotating ring spinner used on Searching/Voice-analyzing screens.
class SpinningRing extends StatefulWidget {
  const SpinningRing({super.key, this.size = 74, this.trackColor = const Color(0xFFDCFCE7), this.activeColor = const Color(0xFF16A34A)});
    ...
    return RotationTransition(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: widget.trackColor, width: 4),
        ),
