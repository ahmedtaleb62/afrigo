...
class RejectedScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final display = reason?.isNotEmpty == true ? reason! : l10n.taxiRejectedDefaultReason;
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(l10n.badgeRejected, style: const TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w700, fontSize: 12, color: Color(0xFFDC2626))),
          ),
          Text(l10n.taxiRejectedTitle, style: const TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.w800, fontSize: 18)),
          ...
          Container(
            ...
            child: Text(l10n.taxiRejectedReasonLabel(display), style: const TextStyle(fontFamily: 'Tajawal', fontSize: 13, height: 1.7, color: Color(0xFF78716C))),
          ),
          TaxiPrimaryButton(label: l10n.taxiResubmitBtn, onPressed: () => controller.goTo(TaxiScreen.vehicleDocs)),
        ],
      ),
    );
  }
